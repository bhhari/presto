        ...
        extends BlockEncodingBuffers
{
    ...
    // The BlockEncodingBuffers for the nested key and value Block of the MapBlock
    private final BlockEncodingBuffers keyBuffers;
    private final BlockEncodingBuffers valueBuffers;

    public MapBlockEncodingBuffers(DecodedBlockNode decodedBlockNode)
    {
    ...
    public long getRetainedSizeInBytes()
    {
        ...
        // This is because the same columnarMap would be hold in all partitions/BlockEncodingBuffers and thus counting it here would be counting it multiple times.
    ...
    {
        offsetsBuffer = ensureCapacity(offsetsBuffer, offsetsBufferIndex + batchSize * ARRAY_INT_INDEX_SCALE, LARGE, true);
    ...
    private void appendHashTables()
    {
        ...
        hashTablesBuffer = ensureCapacity(hashTablesBuffer, hashTableBufferIndex + hashTablesSize * ARRAY_INT_INDEX_SCALE, LARGE, true);
