...
public final class PageAssertions
{
    ...
    public static Page createPage(List<Type> types, int positionCount, boolean allowNulls)
    {
        return createPage(types, positionCount, true, false, allowNulls, false, ImmutableList.of());
    }

    public static Page createDictionaryPage(List<Type> types, int positionCount, boolean allowNulls)
    {
        return createPage(types, positionCount, true, false, allowNulls, false, ImmutableList.of(DICTIONARY));
    }

    public static Page createRLEPage(List<Type> types, int positionCount, boolean allowNulls)
    {
        return createPage(types, positionCount, true, false, allowNulls, false, ImmutableList.of(RUN_LENGTH));
    }

    public static Page createPage(List<Type> types, int positionCount, boolean addPreComputedHashBlockAtBegin, boolean addNullBlockAtEnd, boolean useBlockView, List<Encoding> wrappings)
    {
    ...
    public static Page mergePages(List<Type> types, List<Page> pages)
    {
        ...
        for (Page page : pages) {
            verify(page.getChannelCount() == types.size());
    ...
    public static List<Type> buildTypes(List<Type> types, boolean addPreComputedHashBlock, boolean addNullBlock)
    {
