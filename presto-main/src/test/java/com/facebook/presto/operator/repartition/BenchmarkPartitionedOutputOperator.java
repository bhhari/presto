...
import static com.facebook.presto.operator.PageAssertions.createDictionaryPage;
import static com.facebook.presto.operator.PageAssertions.createRLEPage;
        ...
        private void createPages(String inputType)
        {
            switch (inputType) {
                case "BIGINT":
                    ...
                    dataPage = PageAssertions.createPage(types, POSITION_COUNT, hasNull);
                    pageCount = 5000;
                    break;
                case "DICTIONARY(BIGINT)":
                    types = nCopies(channelCount, BIGINT);
                    dataPage = createDictionaryPage(types, POSITION_COUNT, hasNull);
                    pageCount = 3000;
                    break;
                case "RLE(BIGINT)":
                    types = nCopies(channelCount, BIGINT);
                    dataPage = createRLEPage(types, POSITION_COUNT, hasNull);
                    pageCount = 3000;
                    break;
                case "LONG_DECIMAL":
