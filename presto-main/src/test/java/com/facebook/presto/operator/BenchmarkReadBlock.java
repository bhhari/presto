...
public class BenchmarkReadBlock
{
    ...
    public static class BenchmarkData
    {
        ...
        private final Block blockNoNulls = createLongsBlock(POSITIONS_PER_PAGE, false);
        private final Block blockWithNulls = createLongsBlock(POSITIONS_PER_PAGE, true);
        private final Block dictionaryBlockNoNulls = createDictionaryBlock(blockNoNulls, POSITIONS_PER_PAGE);
        private final Block dictionaryBlockWithNulls = createDictionaryBlock(blockWithNulls, POSITIONS_PER_PAGE);
